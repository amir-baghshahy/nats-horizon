          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-display-sm text-dark-muted animate-fade-in-down animate-delay-100">{dialog.message}</p>
              </div>
            </div>
            <div className="flex items-center justify-end gap-3 mt-6">
              ...
              <button
                ...
                className={`inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2 text-display-sm font-semibold active-scale hover-scale focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-dark-bg ${styles.btn}`}
              >
