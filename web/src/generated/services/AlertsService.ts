...
export class AlertsService {
   ...
   * @throws ApiError
   */
  public static postAlerts(requestBody: Alert): CancelablePromise<Alert> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/alerts",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static deleteAlerts(id: string): CancelablePromise<SuccessResponse> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/alerts/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static getAlerts1(id: string): CancelablePromise<Alert> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/alerts/{id}",
      path: {
