          ...
          <div className="space-y-4">
            <div>
              ...
              <Select
                ...
                onChange={(value) =>
                  setEditForm({ ...editForm, ack_policy: value })
                }
                options={[
            ...
            <div>
              ...
              <Select
                ...
                onChange={(value) =>
                  setEditForm({ ...editForm, deliver_policy: value })
                }
                options={[
                  { value: "all", label: t("common.all") },
            ...
            <div>
              ...
              <Select
                ...
                onChange={(value) =>
                  setEditForm({ ...editForm, replay_policy: value })
                }
                options={[
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditForm({
                    ...editForm,
                    max_deliver: parseInt(e.target.value) || -1,
                  })
                }
              />
            </div>
