...
export function useConsumerDetail(): UseConsumerDetailReturn {
  ...
  const ackMutation = useMutation({
    mutationFn: (sequence: number) => {
      const payload: github_com_amir_nats_monitor_internal_dto_AckMessageRequest = { sequence };
  ...
  const nackMutation = useMutation({
    mutationFn: ({ sequence }: { sequence: number }) => {
      const payload: github_com_amir_nats_monitor_internal_dto_NackMessageRequest = { sequence };
  ...
  const termMutation = useMutation({
    mutationFn: (sequence: number) => {
      const payload: github_com_amir_nats_monitor_internal_dto_AckTermMessageRequest = { sequence };
