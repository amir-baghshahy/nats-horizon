...
export interface UseMetricsReturn {
  ...
  getSeries: (metrics: internal_handlers_MetricsResponse | undefined, name: string, type: string) => MetricSeries | undefined
  streamNames: string[]
...
export function useMetrics(): UseMetricsReturn {
  ...
  const { data: metrics, refetch, isLoading, error } = useQuery({
  ...
  const getSeries = (metrics: internal_handlers_MetricsResponse | undefined, name: string, type: string) => {
