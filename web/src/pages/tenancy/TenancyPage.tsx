      ...
      <PanelCard
        ...
        header={
          <h3 className="text-display-lg font-semibold flex items-center gap-2">
            <Server className="icon-md" /> {t("tenancy.serverConnections")}
          </h3>
        }
      >
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-display-xs text-content-tertiary">
                      ...
                      {status?.latency && (
                        <span>
                          {t("tenancy.latency", { value: status.latency })}
                        </span>
                      )}
                      <span>
                        {t("tenancy.lastChecked", {
                          time: status
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <RefreshCw
                        className={`icon-sm ${testConnectionMutation.isPending && testingUrl === connectionUrl ? "animate-spin" : ""}`}
                      />
                    </button>
                    <button
                      type="button"
                      ...
                      <button
                        ...
                        onClick={async () => {
                          const ok = await confirm({
                            title: t("tenancy.deleteConnection"),
                            message: t("tenancy.deleteConnectionConfirm", {
                              name: connectionName,
                            }),
                  ...
                  >
                    {testResult.healthy ? (
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          {t("tenancy.connectionSuccessful", {
