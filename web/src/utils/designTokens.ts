...
import {
  ...
  RADIUS, ICON, BUTTON, CARD, BADGE, INPUT,
  TRANSITION, Z_INDEX,
  type ButtonSize, type InputSize, type IconSizeValue,
 ...
 */
export function buttonVariant(variant: 'primary' | 'secondary' | 'danger' | 'ghost') {
  const variants = {
    primary: 'bg-primary-600 text-white hover:bg-primary-500 shadow-sm',
    secondary: 'bg-surface-secondary text-content-primary border border-border-default hover:bg-surface-tertiary',
