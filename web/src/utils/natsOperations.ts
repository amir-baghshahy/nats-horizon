...
import type {
  github_com_amir_baghshahy_nats_monitor_internal_dto_PublishMessageRequest,
  github_com_amir_baghshahy_nats_monitor_internal_dto_PurgeStreamRequest,
  github_com_amir_baghshahy_nats_monitor_internal_dto_ReplayRequest,
  github_com_amir_baghshahy_nats_monitor_internal_dto_ResetLagRequest,
  github_com_amir_baghshahy_nats_monitor_internal_dto_UpdateStreamRequest,
} from "../types";
...
export async function resetConsumerLag(
  ...
  try {
    const payload: github_com_amir_baghshahy_nats_monitor_internal_dto_ResetLagRequest | undefined =
...
export async function replayMessages(
  ...
  try {
    const payload: github_com_amir_baghshahy_nats_monitor_internal_dto_ReplayRequest = {};
...
export async function publishMessage(
  streamName: string,
  request: github_com_amir_baghshahy_nats_monitor_internal_dto_PublishMessageRequest,
...
export async function purgeStream(
  ...
  try {
    const payload: github_com_amir_baghshahy_nats_monitor_internal_dto_PurgeStreamRequest | undefined =
...
export async function updateStreamConfig(
  ...
  try {
    const payload: github_com_amir_baghshahy_nats_monitor_internal_dto_UpdateStreamRequest = {
